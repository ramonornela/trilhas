<?
class Certificate_Model_CertificatePerson extends Certificate_Model_Abstract
{
	protected $_name    = "certificate_person";
	...
	protected $_referenceMap = array( 
		array(
			 'refTableClass' => 'Certificate_Model_Certificate',
			 'refColumns' => array( 'id' ),
