...
class Content_Plugin extends Tri_Plugin_Abstract
{
    ...
    public function activate()
    {
        ...
        $this->_addAclItem('content/restriction/form', 'teacher, coordinator, institution');
        $this->_addAclItem('content/restriction/delete', 'teacher, coordinator, institution');
        $this->_addAclItem('content/restriction/save', 'teacher, coordinator, institution');
    ...
    public function desactivate()
    {
        ...
        $this->_removeAclItem('content/restriction/form');
        $this->_removeAclItem('content/restriction/delete');
        $this->_removeAclItem('content/restriction/save');
